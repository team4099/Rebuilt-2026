...
class Leds(
  ...
  override fun periodic() {
    ...
    state =
        ...
        }else if(14<DriverStation.getMatchTime()%25 && DriverStation.getMatchTime()%25 < 15) CandleState.FIRST_WARNING
        else if (4<DriverStation.getMatchTime()%25 && DriverStation.getMatchTime()%25 < 5) CandleState.SECOND_WARNING
