...
object ShooterIOSim : ShooterIO {
  private val shooterSim: FlywheelSim = FlywheelSim(
  ...
  private val shooterPIDController = PIDController(
      ...
      ShooterConstants.PID.SIM_KD
  )

  private var shooterFFController = SimpleMotorFeedforward(
    ShooterConstants.PID.SIM_KS,
    ShooterConstants.PID.SIM_KV,
    ShooterConstants.PID.SIM_KA
  )
  ...
  override fun updateInputs(inputs: ShooterIO.ShooterInputs) {
    ...
    inputs.shooterLeaderAcceleration = shooterSim.angularAccelerationRadPerSecSq.radians.perSecond.perSecond
    ...
    inputs.shooterFollowerAcceleration = shooterSim.angularAccelerationRadPerSecSq.radians.perSecond.perSecond
