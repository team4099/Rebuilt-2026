...
class Shooter(private val io: ShooterIO) : ControlledByStateMachine() {
  ...
  companion object {
    ...
    init {
      ...
      distanceToShooterMap.put(2.37.meters, 31.5.rotations.perSecond)
      distanceToShooterMap.put(2.7.meters, 37.rotations.perSecond)
      distanceToShooterMap.put(2.9.meters, 43.rotations.perSecond)
      distanceToShooterMap.put(3.meters, 44.rotations.perSecond)
      distanceToShooterMap.put(3.35.meters, 48.rotations.perSecond)
      distanceToShooterMap.put(3.6.meters, 49.5.rotations.perSecond)
      distanceToShooterMap.put(3.8.meters, 51.rotations.perSecond)
      distanceToShooterMap.put(4.1.meters, 52.rotations.perSecond)
