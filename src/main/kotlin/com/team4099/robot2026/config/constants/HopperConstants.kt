...
object HopperConstants {
  ...
  object VELOCITIES {
    val IDLE_VELOCITY = 30.degrees.perSecond
    val SCORE_VELOCITY = 1.rotations.perSecond
  }

  object PID {
    val REAL_KP: ProportionalGain<Velocity<Radian>, Ampere> = 0.amps / 1.0.radians.perSecond
    ...
    val REAL_KS: StaticFeedforward<Ampere> = 0.amps
    val REAL_KV: VelocityFeedforward<Radian, Ampere> = 0.0.amps / 1.radians.perSecond
    val REAL_KA: AccelerationFeedforward<Radian, Ampere> =
      (0.016973 / 0.01981).amps / 1.radians.perSecond.perSecond
